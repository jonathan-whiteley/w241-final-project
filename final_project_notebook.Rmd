...
stargazer(basic_mod, full_mod_nohte, full_mod_hte, type = "text", se = list(se.basic_mod, se.full_mod_nohte, se.full_mod_hte), star.cutoffs = c(0.05, 0.01, 0.001), title = "Table 1: The Effect of Framing on Intent to Donate")
