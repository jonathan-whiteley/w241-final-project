...
pilot_group_mean
```
The average willingness to donate in the control group is lower than in the treatment groups. The charts below show the distribution of the outcome variable (i.e. willingness to donate which take values 0-10). We also plot the distribution of the outcome variable by treatment and control groups.
...
We also ran regression to understand ATEs and whether they're statistically significant. Not to out surprise, they are not. We also added covariates in the full model to reduce the standard errors, but treatments are still not statistically significant.
